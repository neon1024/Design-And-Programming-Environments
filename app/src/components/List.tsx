...
export default function List() {
    ...
    return (
        <>
            <button className="border rounded m-2" type="button" onClick={removeSelectedItems}>delete</button>
            <button className="border rounded m-2" type="button" onClick={exportSelectedItems}>export JSON</button>
